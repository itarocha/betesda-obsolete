    ...
    <el-container>
        ...
        <el-aside width="280px">
          ...
          <el-menu
            ...
            <el-menu-item index="1-1" route="/"><i class="fas fa-home pr"></i>Home</el-menu-item>
            <el-submenu index="1">
              <template slot="title">
