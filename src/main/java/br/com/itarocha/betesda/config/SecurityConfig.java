        ...
        http
                ...
                .authorizeRequests()
                    ...
                    .antMatchers("/api/auth/**")
                        .permitAll()
                    .antMatchers("/api/user/checkUsernameAvailability", "/api/user/checkEmailAvailability") //, "/api/app/**"
                        .permitAll()
                    //.antMatchers(HttpMethod.GET, "/api/hospedagens/**", "/api/pessoas/**", "/api/users/**")
                    //    .permitAll()
                    .anyRequest()
                        .authenticated();
