...
export default {
  ...
  data: () =>({
    titulo : "Incluir/Alterar Tipo de Hóspede",
    form:{},
    dados: [],
    errors:[],
    dialogVisible : false
  ...
  methods: {
    openDialog(form){
      this.reset()
      if (!form){
        this.titulo = "Incluir Tipo de Hóspede"
        this.reset()
      } else {
        this.titulo = "Alterar Tipo de Hóspede"
        this.form = form
      }
    ...
    save(evt) {
      ...
      let uri = petra.base_uri+"/tipo_hospede";
