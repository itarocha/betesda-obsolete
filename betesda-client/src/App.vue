<template>
  <div id="app">
      ...
      <b-navbar toggleable="md" type="dark" variant="info">
        ...
        <b-navbar-brand href="#" class="font-weight-bold">Casa Betesda - Teste</b-navbar-brand>
        ...
        <b-collapse is-nav id="nav_collapse">
          ...
          <b-navbar-nav>
            ...
            <b-nav-item-dropdown text="Movimentação" right>
              <b-dropdown-item href="#">Checkin</b-dropdown-item>
              <b-dropdown-item href="#">Hospedagens</b-dropdown-item>
            </b-nav-item-dropdown>
          </b-navbar-nav>
